<%-- 
    Document   : yahoo_module_settings
...
<html>
    <head>
        ...
        <title>Yahoo Store Order Status Update</title>
    ...
    <body>
        <div>
            <h2>Yahoo Order Status Update</h2>
            <p>This module updates the Yahoo store order status in accordance with specifications mentioned in their <a target="_blank" href="https://help.yahoo.com/kb/yahoo-merchant-solutions/SLN19401.html">Updating Tracking Status Automatically</a> article.</p>
            <form action="" method="POST" class="form-inline">
                <p><a href="./" class="btn btn-info" role="button"><span class="glyphicon glyphicon-chevron-left"></span> Back</a></p>
